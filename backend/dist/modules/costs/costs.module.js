...
exports.CostsModule = CostsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([cost_category_entity_1.CostCategory, cost_item_entity_1.CostItem, cost_payment_entity_1.CostPayment, asset_transaction_entity_1.AssetTransaction]),
