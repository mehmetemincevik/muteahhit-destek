...
export default function CreateBuyerScreen({ navigation }: any) {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      // Alıcı listesine geri dön -- useFocusEffect sayesinde yeni alıcı listede görünür.
      // Eğer bu ekrana bir daire satışı akışından gelindiyse, kullanıcı listeden yeni
      // eklediği alıcıyı seçerek satışı tamamlayabilir.
      navigation.goBack();
    } catch (error: any) {
