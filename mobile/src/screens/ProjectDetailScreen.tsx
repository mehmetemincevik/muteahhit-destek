...
// Daireleri kat numarasına göre gruplar, EN ÜST KAT EN ÜSTTE olacak şekilde sıralar --
// gerçek bir bina kesiti çiziminde olduğu gibi (zemin kat en altta). Bu, kart listesi
// yerine seçtiğimiz "imza" görsel öğe: her satır bir kat, her hücre bir daire.
//
// NOT (basitleştirme): sadece İÇİNDE DAİRE OLAN katlar gösteriliyor. Henüz hiç daire
// eklenmemiş boş katlar (floorCount'a rağmen) şimdilik gösterilmiyor -- ileride
// geliştirilebilir bir nokta.
...
export default function ProjectDetailScreen({ route, navigation }: any) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {/* Durum lejantı -- ızgaradaki renklerin ne anlama geldiğini gösterir */}
