...
export default function CostsScreen({ route, navigation }: any) {
  ...
  // Sabit (fixed) ve değişken (variable) maliyetleri ayrı topluyoruz -- müteahhit için
  // bu ayrım önemli: sabit maliyetler öngörülebilir, değişkenler piyasaya göre dalgalanır.
    ...
    <View style={styles.container}>
      ...
      {!isLoading && grandTotal > 0 && (
        <View style={styles.summaryCard}>
          ...
          {/* Sabit / değişken dağılım çubuğu -- tek bakışta oran gösterir */}
