...
export default function RegisterScreen({ navigation }: any) {
  ...
  async function handleRegister() {
    ...
    try {
      ...
      // Hatanın gerçek sebebini göstermek için üç kaynağa bakıyoruz:
      // 1) backend'in döndüğü mesaj (örn. "Bu telefon numarasıyla zaten bir hesap var")
      // 2) axios'un ağ hatası (backend'e hiç ulaşılamadıysa)
      // 3) HTTP durum kodu (örn. 429 = çok fazla deneme yaptın)
