...
// Vade tarihine kalan gün sayısı -- negatifse gecikmiş demektir
...
export default function CashflowScreen({ navigation }: any) {
  ...
  // Bekleyen gelir/gider toplamları -- ödenmiş olanlar hariç, çünkü müteahhidi
  // ilgilendiren şey "önümde ne var" bilgisi
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            ...
            >
              {/* Sol taraftaki dikey renk şeridi -- durumu tek bakışta gösterir */}
              <View
                style={[
                  styles.statusStripe,
                  {
              ...
              <View style={styles.entryContent}>
                ...
                {/* Faiz işlemişse orijinal tutarı da gösteriyoruz ki fark anlaşılsın */}
                {hasInterest && !isPaid && (
